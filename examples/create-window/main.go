...
func main() {
	...
	for {
		...
		case xproto.KeyPressEvent:
			// See https://pkg.go.dev/github.com/ali-mohit/xgb-advance/xproto#KeyPressEvent
		...
		case xproto.DestroyNotifyEvent:
			...
			// https://github.com/ali-mohit/xgb-advanceutil/blob/master/_examples/graceful-window-close/main.go
			return
		}
	}
}
